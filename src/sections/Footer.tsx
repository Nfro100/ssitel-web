  ...
  return (
    ...
    >
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <h2 className="font-display text-[10vw] text-white leading-none tracking-tighter">
      ...
      <div className="relative bg-void-black py-20 px-6 md:px-12">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-display text-xl uppercase tracking-wider text-white mb-6">
          ...
          {footerConfig.galleryImages.length > 0 && (
            <div className="mb-12">
              <p className="font-mono-custom text-xl text-white/30 uppercase tracking-wider mb-4">
                Gallery
              </p>
                ...
                {footerConfig.galleryImages.map((image, index) => (
                  ...
                  >
                    <img
                      src={image.src}
                      alt=""
                      className={`w-full h-full object-cover transition-all duration-300 ${hoveredImage === index ? 'scale-110 brightness-110' : 'brightness-75'
                        }`}
                    />
                  </div>
                ))}
